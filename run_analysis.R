...
#Dropping non mean or standard deviation measures
# getting the column names
cnames<-colnames(cdata)
# setting a transposed logical vector of columns that have the desired information
...
#create columns to group summary data by
